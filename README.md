<p align="center">
  <a href="https://github.com/ishandutta2007/Awesome-Marketing-Automation">
    <img src="assets/banner.svg" alt="Awesome Marketing Automation Banner" width="100%" />
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/ishandutta2007/Awesome-Marketing-Automation/stargazers"><img src="https://img.shields.io/github/stars/ishandutta2007/Awesome-Marketing-Automation?style=flat-square&color=gold" alt="Stars"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-Marketing-Automation/network/members"><img src="https://img.shields.io/github/forks/ishandutta2007/Awesome-Marketing-Automation?style=flat-square&color=blue" alt="Forks"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-Marketing-Automation/pulls"><img src="https://img.shields.io/badge/PRs-Welcome-brightgreen?style=flat-square" alt="PRs Welcome"/></a>
  <a href="LICENSE"><img src="https://img.shields.io/github/license/ishandutta2007/Awesome-Marketing-Automation?style=flat-square" alt="License"/></a>
...
| 🧩 **[Activepieces](https://github.com/activepieces/activepieces)** | Open-source no-code workflow automation platform designed to automate marketing campaigns, lead sync, and CRM operations with 100+ integrations. *(TypeScript / Node.js)* | [![Activepieces Stars](https://img.shields.io/github/stars/activepieces/activepieces?style=social&color=white)](https://github.com/activepieces/activepieces/stargazers) |
| 🚀 **[Listmonk](https://github.com/knadh/listmonk)** | High-performance, self-hosted newsletter and mailing list manager with a sleek dashboard, custom templates, and fast bulk/transactional dispatch. *(Go + PostgreSQL)* | [![Listmonk Stars](https://img.shields.io/github/stars/knadh/listmonk?style=social&color=white)](https://github.com/knadh/listmonk/stargazers) |
| 📮 **[Postal](https://github.com/postalserver/postal)** | Full-featured open-source mail delivery platform for incoming and outgoing application and marketing emails, providing webhooks, tracking, and web admin. *(Ruby / MariaDB)* | [![Postal Stars](https://img.shields.io/github/stars/postalserver/postal?style=social&color=white)](https://github.com/postalserver/postal/stargazers) |
| 📝 **[Formbricks](https://github.com/formbricks/formbricks)** | Open-source customer survey and feedback engine for targeted micro-surveys, user profiling, and behavioral lead enrichment. *(Next.js / TypeScript)* | [![Formbricks Stars](https://img.shields.io/github/stars/formbricks/formbricks?style=social&color=white)](https://github.com/formbricks/formbricks/stargazers) |
| 🛠️ **[Mautic](https://github.com/mautic/mautic)** | The world's flagship open-source marketing automation suite—visual campaign builder, email journeys, lead scoring, forms, landing pages, & CRM sync. *(PHP / Symfony / MySQL)* | [![Mautic Stars](https://img.shields.io/github/stars/mautic/mautic?style=social&color=white)](https://github.com/mautic/mautic/stargazers) |
| 💼 **[erxes](https://github.com/erxes/erxes)** | Open-source Experience Operating System (XOS) combining marketing automation, sales pipelines, live chat, and customer service in a single platform. *(TypeScript / React)* | [![erxes Stars](https://img.shields.io/github/stars/erxes/erxes?style=social&color=white)](https://github.com/erxes/erxes/stargazers) |
| 💌 **[Mail for Good](https://github.com/freeCodeCamp/mail-for-good)** | Open-source email campaign management platform for non-profits and creators built on top of AWS SES for high-volume delivery. *(Node.js / React)* | [![Mail for Good Stars](https://img.shields.io/github/stars/freeCodeCamp/mail-for-good?style=social&color=white)](https://github.com/freeCodeCamp/mail-for-good/stargazers) |
| 💬 **[Dittofeed](https://github.com/dittofeed/dittofeed)** | Developer-first, open-source customer engagement platform for automated lifecycle and transactional messages across email, SMS, WhatsApp, and push. *(TypeScript / ClickHouse)* | [![Dittofeed Stars](https://img.shields.io/github/stars/dittofeed/dittofeed?style=social&color=white)](https://github.com/dittofeed/dittofeed/stargazers) |
| 📤 **[SendPortal](https://github.com/mettle/sendportal)** | Self-hosted email marketing management platform for managing subscribers, lists, and campaign tracking via third-party SMTP/SES providers. *(PHP / Laravel)* | [![SendPortal Stars](https://img.shields.io/github/stars/mettle/sendportal?style=social&color=white)](https://github.com/mettle/sendportal/stargazers) |
| 📰 **[phpList](https://github.com/phpList/phplist3)** | Battle-tested open-source newsletter and email marketing system for subscriber list management, click tracking, and segment automation. *(PHP / MySQL)* | [![phpList Stars](https://img.shields.io/github/stars/phpList/phplist3?style=social&color=white)](https://github.com/phpList/phplist3/stargazers) |
| 🏛️ **[CiviCRM](https://github.com/civicrm/civicrm-core)** | Open-source constituent relationship management (CRM) suite tailored for nonprofits, associations, and civic groups with automated email journeys. *(PHP / MySQL)* | [![CiviCRM Stars](https://img.shields.io/github/stars/civicrm/civicrm-core?style=social&color=white)](https://github.com/civicrm/civicrm-core/stargazers) |
...
```mermaid
flowchart LR
    A["👤 User Actions / Product Events"] --> B["⚡ Open/Commercial Pipeline (n8n / Novu / Segment)"]
    B --> C["🧠 Marketing Automation Engine (Mautic / Customer.io)"]
    C --> D["📊 CRM & Customer DB (HubSpot / Salesforce / Postgres)"]
    C --> E["📨 Delivery Layer (AWS SES / Mailgun / Postal)"]
    E --> F["📬 Multi-Channel Engagement (Email, SMS, Push, In-App)"]
```
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Marketing-Automation&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Marketing-Automation&type=date&legend=top-left)

---

<p align="center">
  <sub>Maintained with ❤️ for marketers, growth engineers, and open-source enthusiasts worldwide.</sub>
</p>
